...
class Config:
    def __init__(self):
        ...
        # 1. Financial Datasets MCP - Uses uv run server.py
        # Set API keys
        ...
        # 2. FRED API MCP - Uses uv run server.py
        # Set API keys
        ...
        # 3. Perplexity Search MCP - Uses Docker
        # Set API keys
    ...
    def _validate_config(self):
        ...
        # Check if uv is installed for fredapi and financial-datasets
        try:
