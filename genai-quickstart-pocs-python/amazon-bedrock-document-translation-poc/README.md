# Amazon Bedrock Document Translation POC
...
![A gif of a screen recording show casing the Amazon Bedrock Document Translation POC functionality](images/demo.gif)
...
1. Open the repository in your favorite code editor. In the terminal, navigate to the POC's folder:
    ```zsh
    cd genai-quickstart-pocs-python/amazon-bedrock-document-translation-poc
    ```
