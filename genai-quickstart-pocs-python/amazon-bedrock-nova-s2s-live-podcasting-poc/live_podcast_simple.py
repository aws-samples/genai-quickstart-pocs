...
from guardrails import is_valid_aws_topic, scrub_pii
...
def generate():
    ...
    if not is_valid_aws_topic(topic):
        return jsonify({'error': 'Topic must be related to AWS services or cloud computing. Try topics like S3, Lambda, EC2, serverless, etc.'}), 400
    ...
    def event_stream():
        ...
        try:
            ...
            for i in range(10):
                ...
                # Scrub any PII from the response before streaming
                bot_response = scrub_pii(bot_response)
