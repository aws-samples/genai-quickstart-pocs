...
def display_config_tab(get_snowflake_databases_fn, get_snowflake_schemas_fn, get_available_models_fn):
    """
    Display the configuration tab.
    
    Args:
        get_snowflake_databases_fn (function): Function to get Snowflake databases.
        get_snowflake_schemas_fn (function): Function to get Snowflake schemas.
    ...
    databases = get_snowflake_databases_fn()
    ...
    schemas = get_snowflake_schemas_fn(selected_db) if selected_db else []
