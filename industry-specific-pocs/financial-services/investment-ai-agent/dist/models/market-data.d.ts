 ...
 * Market data types
 */
export type MarketDataType = 'price' | 'volume' | 'order-book' | 'technical-indicators' | 'news-sentiment' | 'economic-indicators' | 'volatility-metrics' | 'options-data' | 'futures-data' | 'forex-data';
/**
 * Market data intervals
 */
export type MarketDataInterval = 'tick' | '1min' | '5min' | '15min' | '30min' | '1hour' | '4hour' | 'daily' | 'weekly' | 'monthly';
/**
 * Market data point
 */
 ...
 * Alert condition
 */
export type AlertCondition = 'greater-than' | 'less-than' | 'equal-to' | 'percent-change-up' | 'percent-change-down' | 'crosses-above' | 'crosses-below' | 'volume-spike' | 'volatility-increase' | 'custom';
/**
