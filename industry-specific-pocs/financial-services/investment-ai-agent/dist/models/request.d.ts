...
export type RequestType = 'investment-idea-generation' | 'investment-analysis' | 'market-research' | 'portfolio-optimization' | 'risk-assessment' | 'compliance-check';
export type RequestStatus = 'submitted' | 'queued' | 'processing' | 'completed' | 'failed' | 'cancelled';
