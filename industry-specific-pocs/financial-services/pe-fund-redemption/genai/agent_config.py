...
import tools.pe_kb_search as pe_kb_search
...
def create_strands_agent(model = 'us.amazon.nova-micro-v1:0',
    ...
    # Add PE knowledge base search tool for analyst personality
    if personality == 'analyst':
        tools_list.append(pe_kb_search)
        print("Added PE knowledge base search tool for analyst personality")
